    ...
    function nextQuestion() {
        ...
        if (counter > 8) {
            $('#a1, #a2, #a3, #a4, #a5, #question').fadeOut("slow", function () {
                if (right == 9){
                    var result = $("<div id='question' class='field is-size-4'><strong class='has-text-success'>Obtuviste " + right +"/9 respuestas correctas.</strong></br><div class='is-size-5'> Wow! Vos sí que conoces a Sofi! O la conoces muy bien o sos un terrible stalker. Claramente ya conocés a sofi, pero si queres podes mirar más abajo más info sobre la cumpleañera!</div></div>").hide();
                }
                else if (right >= 7){
                    var result = $("<div id='question' class='field is-size-4'><strong class='has-text-success'>Obtuviste " + right +"/9 respuestas correctas.</strong></br><div class='is-size-5'> Super sólido! Claramente sos bastante cercano a Sofi. Hacé para abajo para conocer más sobre la cumpleañera!</div></div>").hide();
                }
                    ...
                    var result = $("<div id='question' class='field is-size-4'><strong class='has-text-danger'>Obtuviste " + right +"/9 respuestas correctas.</strong></br><div class='is-size-5'> Wow sos malísimo! Conoces a Sofi o viniste de colado a la fiesta? 😂. Mas abajo podes leer más info sobre la cumpleañera.</div></div>").hide();
                }
